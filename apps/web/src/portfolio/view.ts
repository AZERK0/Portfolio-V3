...
function renderSocialIconButtons() {
  ...
  return `<a href="#" aria-label="LinkedIn" class="${itemClass}"><svg viewBox="0 0 24 24" class="h-4 w-4 fill-current"><path d="M4.98 3.5C4.98 4.88 3.86 6 2.48 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.5 8h4V23h-4V8zm7 0h3.84v2.05h.05c.53-1.01 1.84-2.07 3.78-2.07 4.04 0 4.79 2.66 4.79 6.11V23h-4v-7.76c0-1.85-.03-4.23-2.58-4.23-2.58 0-2.97 2.01-2.97 4.09V23h-4V8z"/></svg></a><a href="#" aria-label="GitHub" class="${itemClass}"><svg viewBox="0 0 24 24" class="h-4 w-4 fill-current"><path d="M12 .5a12 12 0 0 0-3.79 23.39c.6.11.82-.26.82-.58v-2.03c-3.34.73-4.04-1.41-4.04-1.41a3.19 3.19 0 0 0-1.34-1.76c-1.1-.75.08-.73.08-.73a2.53 2.53 0 0 1 1.85 1.24 2.58 2.58 0 0 0 3.53 1 2.58 2.58 0 0 1 .77-1.62c-2.66-.3-5.47-1.33-5.47-5.9a4.61 4.61 0 0 1 1.23-3.2 4.28 4.28 0 0 1 .12-3.15s1-.32 3.3 1.22a11.42 11.42 0 0 1 6 0c2.29-1.54 3.29-1.22 3.29-1.22a4.28 4.28 0 0 1 .12 3.15 4.6 4.6 0 0 1 1.23 3.2c0 4.58-2.82 5.6-5.5 5.9a2.88 2.88 0 0 1 .83 2.23v3.3c0 .32.21.7.83.58A12 12 0 0 0 12 .5z"/></svg></a>`;
}

function renderHeader() {
  return `<header class="sticky top-4 z-40 w-full"><div class="mx-auto flex h-14 max-w-fit items-center justify-between gap-6 rounded-full border border-white/10 bg-white/5 px-6 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.1)]"><div class="flex items-center gap-2 text-[#eaddcf]"><span class="material-symbols-outlined text-[#f48c25]">terminal</span><span class="text-lg font-bold tracking-tight">${portfolioData.firstName.toUpperCase()}.DEV</span></div><div class="h-5 w-px bg-white/10"></div><nav class="hidden items-center gap-1 md:flex"><a href="#" class="rounded-full px-4 py-1.5 text-sm font-medium text-[#9d8a76] transition hover:bg-white/5 hover:text-[#eaddcf]">Projects</a><a href="#" class="rounded-full px-4 py-1.5 text-sm font-medium text-[#9d8a76] transition hover:bg-white/5 hover:text-[#eaddcf]">Experience</a><a href="#" class="rounded-full px-4 py-1.5 text-sm font-medium text-[#9d8a76] transition hover:bg-white/5 hover:text-[#eaddcf]">Contact</a></nav><div class="h-5 w-px bg-white/10"></div><div class="flex items-center gap-2"><a href="#" class="inline-flex h-8 items-center justify-center rounded-full bg-gradient-to-r from-[#f48c25] to-[#d4740a] px-4 text-sm font-semibold text-[#1a120b] transition hover:shadow-[0_0_20px_rgba(244,140,37,0.5)] hover:scale-105"><span class="material-symbols-outlined mr-1.5 text-[16px]">download</span>Resume</a>${renderSocialIconButtons()}</div></div></header>`;
}
